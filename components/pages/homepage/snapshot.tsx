...
export default function Snapshot() {
	...
	const cards = [
		{
			title: "Secure & Accessible Everywhere",
			description:
				"Web-based platform accessible from anywhere, ensuring your team stays connected with secure, role-based access.",
			image: "/modern-dashboard-interface-with-data-visualization.jpg",
		},
		{
			title: "Tailored HSCL Workflows",
			description:
				"Thoughtfully designed around HSCL’s specific processes, making daily operations intuitive and efficient.",
			image: "/analytics-dashboard.png",
		},
		{
			title: "Scalable for Growth",
			description:
				"Built on a scalable foundation that evolves with your needs, ready for future modules and expansion.",
			image: "/team-collaboration-interface-with-shared-workspace.jpg",
		},
		{
			title: "Guided Onboarding Support",
			description:
				"Includes detailed user guides and dedicated onboarding support to help everyone get started instantly.",
			image: "/team-collaboration-interface-with-shared-workspace.jpg",
		},
	];
	...
	return (
		<div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center max-w-7xl mx-auto">
			{/* Header Section */}
