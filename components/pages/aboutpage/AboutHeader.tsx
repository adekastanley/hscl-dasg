...
export default function AboutHeader() {
	return (
		<section className="max-sm:pb-60 w-full relative bg-no-repeat  mx-auto pt-16 md:pt-24 space-y-6 px-6  h-[90dvh] flex items-center min-h-[90dvh]  bg-[url(/assets/ab.jpg)] bg-cover bg-center  mask-[linear-gradient(to_bottom,black_80%,transparent_100%)] ">
